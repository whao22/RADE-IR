...
def load_model(gender='neutral', use_cuda=True, model_type='smpl', skel_type='body25', device=None, model_path='tools/body_models'):
    # prepare SMPL model
    ...
    if model_type == 'smpl':
        if skel_type == 'body25':
            ...
            reg_path = join(model_path, 'misc', 'J_regressors.npz')
        else:
