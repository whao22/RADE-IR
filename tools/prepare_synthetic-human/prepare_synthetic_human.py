...
if __name__ == '__main__':
    ''' python tools/prepare_synthetic-human/prepare_synthetic_human.py --conf /home/wanghao/workspace/HF-Avatar/tools/prepare_synthetic_human/confs_preprocess/jody.yaml '''
    cfg = parse_cfg()
    main(cfg)
